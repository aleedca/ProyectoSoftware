-- Autor:       Luis Molina
-- Fecha:       2024-09-21
-- Descripci�n: Procedure to edit a Modality information.
--------------------------------------------------------------------------

CREATE OR ALTER PROCEDURE [dbo].[InloTEC_SP_Modality_Edit]
    -- Parameters
